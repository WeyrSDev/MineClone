...
{
	m_blocks[static_cast<BlockId>(BlocksIds::air)] = std::make_unique<BlockData>(Vec2(0, 0), Vec2(0, 0), Vec2(0, 0));
	...
	m_blocks[static_cast<BlockId>(BlocksIds::water)] = std::make_unique<BlockData>(Vec2(7, 0), Vec2(7, 0), Vec2(7, 0));
}
