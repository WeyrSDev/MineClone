...
{
	unsigned int h1 = 40 * m_heightMap1.noise(x, z, ChunkLength, 1.f / 20.f)
		+ 20 * m_heightMap1.noise(x, z, ChunkLength, 1.f / 10.f);
	unsigned int h2 =  10
		+ 40 * m_heightMap2.noise(x, z, ChunkLength, 1.f / 10.f)
		+ 15 * m_heightMap2.noise(x, z, ChunkLength, 1.f / 5.f);
